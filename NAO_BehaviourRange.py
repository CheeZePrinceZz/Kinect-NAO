...
##################################################################################################################################
##################################################################################################################################
Content1 = """Hi I'm NAO. Today I want to start by asking you to pay attention to what posture you are doing right now.
I hope that if you learn to tweak this a little bit, it could significantly change the way your life unfolds.
So, we are really fascinated with body language, and we are particularly interested in other peoples body language.
You know, we are interested in an awkward interaction, or a smile, or a contemptuous glance, or maybe a very awkward wink, or maybe even something like a handshake.
So obviously when we think about nonverbal behavior, or body language. We think about communication. When we think about communication, we think about interactions.
So what is your body language communicating to me? What's mine communicating to you? So social scientists have spent a lot of time looking at the effects of our body language, 
or other peoples body language, on judgments. And we make sweeping judgments and inferences from body language. 
And those judgments can predict really meaningful life outcomes like who we hire or promote, who we ask out on a date. And this is the end for this session."""

Content2 = """Okay, let’s continue. Dr. Nalini Ambady, a researcher at Tufts University, shows that when people watch 30 seconds soundless clips of real physician-patient interactions, 
their judgments of the physician's niceness predict whether or not that physician will be sued. So it doesn't have to do so much with whether or not that physician was incompetent, 
but do we like that person and how they interacted. Another dramatic example is from the study of Alex Todorov which shows that judgments of political candidates' faces in just one second
predict 70 percent of U.S. Senate and gubernatorial race outcomes. Well, when we think of nonverbals, we think of how we judge others, how they judge us and what the outcomes are. 
We tend to forget, though, the other audience that's influenced by our nonverbals, and that's ourselves. We are also influenced by our nonverbals, 
our thoughts and our feelings and our physiology. Here, I’m talking about nonverbal expressions of power and dominance. And what are nonverbal expressions of power and dominance? 
And this is the end for this session."""

Content3 = """Let’s continue to our third part. In the animal kingdom, they are about expanding. So you make yourself big, you stretch out, you take up space, you're basically opening up. 
It's about opening up. And this is true across the animal kingdom. It's not just limited to primates. And humans do the same thing. 
So they do this both when they have power sort of chronically, and also when they're feeling powerful in the moment. And this one is especially interesting
ecause it really shows us how universal and old these expressions of power are. This expression, which is known as pride, Jessica Tracy has studied.
...
So when they cross the finish line and they've won, it doesn't matter if they've never seen anyone do it. They do this. So the arms up in the V,
the chin is slightly lifted. What do we do when we feel powerless? We do exactly the opposite. We close up. We wrap ourselves up. We make ourselves small.
We don't want to bump into the person next to us. And this is the end for this session."""

Content4 = """Now let’s move on to the forth part. Both animals and humans do the same thing. And this is what happens when you put together high and low power. 
...
When they sit down, they're sort of spread out. They raise their hands. You have other people who are virtually collapsing when they come in. As soon they come in,
they sit in their chair and they make themselves tiny. Well, you're not going to be surprised. It seems to be related to gender. 
So women are much more likely to do this kind of thing than men. Women feel chronically less powerful than men, so this is not surprising. And this is the end for this session."""

Content5 = """Let’s continue, The other thing I noticed, other than gender, is that it also seemed to be related to the extent to which the students were participating,
and how well they were participating. You get these equally qualified women and men coming in and then you get these differences in grades, 
and it seems to be partly attributable to participation. So we started to wonder, Is it possible that we could get people to fake it and would it lead them to participate more?
In Dana Carney’s study, he really wanted to know, can you fake it till you make it? Like, can you do this just for a little while and actually experience a behavioral outcome that makes you seem more powerful? So we know that our nonverbals govern how other people think and feel about us. There's a lot of evidence. But our question really was, 
do our nonverbals govern how we think and feel about ourselves? There's some evidence that they do. For example, we smile when we feel happy, 
but also, when we're forced to smile by holding a pen in our teeth, it makes us feel happy. So it goes both ways. When it comes to power, it also goes both ways. 
And this is the end for this session."""

Content6 = """Okay. Let’s continue. When you feel powerful, you're more likely to go big, but it's also possible that when you pretend to be powerful,
you are more likely to actually feel powerful. Now we know that our minds change our bodies, but is it also true that our bodies change our minds? And when I say minds,
in the case of the powerful. I'm talking about thoughts and feelings and the sort of physiological things that make up our thoughts and feelings, and in my case, that's hormones.
...
They actually feel they're going to win even at games of chance. They also tend to be able to think more abstractly. So there are a lot of differences.
They take more risks. There are a lot of differences between powerful and powerless people. Physiologically, there also are differences on two key hormones:
testosterone, which is the dominance hormone, and cortisol, which is the stress hormone. And this is the end for this session."""

Content7 = """ Next, what we find is that high-power alpha males in primate hierarchies have high testosterone and low cortisol, 
and powerful and effective leaders also have high testosterone and low cortisol. So what does that mean? When you think about power, people tended to think only about testosterone, 
because that was about dominance. But really, power is also about how you react to stress. So do you want the high-power leader that's dominant, high on testosterone,
but really stress reactive? Probably not. You want the person who's powerful and assertive and dominant, but not very stress reactive, the person who's laid back.
So we know that in primate hierarchies, if an alpha needs to take over, if an individual needs to take over an alpha role sort of suddenly, 
within a few days, that individual's testosterone has gone up significantly and his cortisol has dropped significantly. 
And this is the end for this session."""

Content8 = """Well, let’s continue. so now we have this evidence, both that the body can shape the mind, at least at the facial level, and also that role changes can shape the mind.
But. What happens if you do that at a really minimal level? In Amy’s study, they decided to bring people into the lab and run an experiment,
and these people adopted, for two minutes, either high-power poses or low-power poses. And this is what happens.
They came in and the experimenters took their saliva sample. Then, asked them to do the poses for two minutes and then ask them,
How powerful do you feel? on a series of items. After that the experimenter gave them an opportunity to gamble, and took another saliva sample. 
That's it. That's the whole experiment. We will continue to their findings in the next session. And this is the end for this session."""

Content9 = """So this is what we find. Risk tolerance, which is the gambling, we find that when you are in the high-power pose condition, 86 percent of the participant will gamble. 
...
So again, only two minutes, we can see the changes. Here's what they found in cortisol. High-power people experience about a 25 percent decrease, 
and the low-power people experience about a 15 percent increase. So two minutes lead to these hormonal changes that configure your brain to basically be either assertive,
confident and comfortable, or really stress-reactive, and feeling sort of shut down. And this is the end for this session."""

Content10 = """Let’s continue. So, it seems that our nonverbals do govern how we think and feel about ourselves, so it's not just others, but it's also ourselves. 
Also, our bodies change our minds. But the next question is can power posing for a few minutes really change your life in meaningful ways? Where can you actually apply this?
The answer is the evaluative situations, like social threat situations. Where are you being evaluated by your friends?
For example, at the lunchroom table, at a meeting or a job interview. Again, the researcher, Amy, bring people into a lab, and they do either high or low-power poses again, 
they go through a very stressful job interview. It's five minutes long and is video recorded. They're being judged also, and the judges are trained to give no nonverbal feedback. 
So for five minutes, nothing. People hate this. So this really spikes their cortisol. Four coders look at the recorded tapes, and they say,
We want to hire these people, which are all the high-power posers.  And this is the end of this session."""

Content11 = """So, what's driving their decision? It's not about the content of the speech. It's about the presence that they're bringing to the speech. 
People are bringing their true selves, basically. They bring their ideas as themselves, with no residue over them. So this is what's driving the effect,
or mediating the effect. The reason why Amy insists that our bodies change our minds and our minds can change our behavior, and our behavior can change our outcomes is according to her own experience. That’s why she continues her study on this path. When she was a teenager, she was in a really bad car accident and got head injury,
which causes her brain trauma and changes her from a smart girl to low IQ person so she was taken out of college. Due to her injury condition,
everyone said she’s not going to finish college. And this is the end of this session."""

Content12 = """Okay, let’s continue. Eventually Amy graduated from college. It took her four years longer than her peers, and she convinced her advisor, Susan Fiske,
to take her on, and so she ended up at Princeton, and she was like, she is not supposed to be here. She is an impostor. And the night before her first-year talk,
and the first-year talk at Princeton is a 20-minute talk to 20 people. That's it. She was so afraid of being found out the next day that she called her advisor and said, I'm quitting.
And her advisor told her that, "You are not quitting, because I took a gamble on you, and you're staying. You're going to stay, and this is what you're going to do. You are going to fake it.
You're going to do every talk that you ever get asked to do. You're just going to do it and do it and do it, even if you're terrified and just paralyzed and having an out-of-body experience,
until you have this moment where you say, Oh my gosh, I'm doing it. And I have become this. I am actually doing this. And this is the end of this session."""

Content13 = """So that’s what Amy did, empowering herself. And you know what, at this moment, she is now a professor at Harvard. At the end of her first year at Harvard,
a student who had not talked in class the entire semester, came into her office. She really didn't know her at all. Her student came in totally defeated, and said,
I'm not supposed to be here. And that was the moment for Amy. She realized, oh my gosh, I don't feel like that anymore. I don't feel that anymore, but her student does,
and she totally understand her student’s feeling. So she told her student, Yes, you are supposed to be here! and tomorrow you’re going to fake it, you’re going to make yourself powerful.
And you're going to go into the classroom, and you are going to give the best comment ever. Her student comes back to Amy months later,
and she realized that her student had not just faked it till she made it, she had actually faked it till she became it. And this is the end of this session."""

Content14 = """Well, from Amy’s and her student’s story, we all learn that don't fake it till you make it. Fake it till you become it.
Do it enough until you actually become it and internalize. The last thing I'm going to leave you with is this. Tiny tweaks can lead to big changes.
So, this is two minutes. Before you go into the next stressful evaluative situation, for two minutes, try doing this, in the elevator,
in a bathroom stall, at your desk behind closed doors. That's what you want to do. Configure your brain to cope the best in that situation.
Get your testosterone up. Get your cortisol down. Don't leave that situation feeling like, oh, I didn't show them who I am.
Leave that situation feeling like, I really feel like I got to say who I am and show who I am. And this is the end of this session."""

Content15 = """So, this is the last part of my talk. From the start of this talk, I was mainly talking about how your nonverbal behaviour can empower and make a change in your life.
Before I finish my talk today, I would like to convince you to try power posing, especially in tough situation to empower yourself,
and also I want to ask you to share this story to others too. Share it with people, because the people who can use it the most are
the ones with no resources and no technology and no status and no power. We just need our bodies and two minutes.
Empowering yourself is very simple. Just two minutes to empower yourself, and it can significantly change the outcomes of your life.
Tiny tweaks can lead to big changes. Because, afterall, your body language may shape who you are. And this is the end of my talk.
...
# And we make sweeping judgments and inferences from body language. And those judgments can predict really meaningful life outcomes like who we hire or promote, who we ask out on a date. For example, Nalini Ambady, a researcher at Tufts University, shows that when people watch 30 seconds soundless clips of real physician-patient interactions, 
...
def main():
    ...
    if Condition == 1:
        ...
        process2 = threading.Thread(target = FaceTracking)
        process2.daemon = True
        process3 = threading.Thread(target = GazeBehaviour)
        process3.daemon = True
        process1.start()
        process2.start()
        process3.start()
        ...
        process3 = threading.Thread(target = GazeBehaviour)
        process3.daemon = True
        process4 = threading.Thread(target = HeadNoddingImitation)
        process4.daemon = True
        process5 = threading.Thread(target = HeadNoddingInitiation)
